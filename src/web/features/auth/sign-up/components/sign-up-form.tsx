  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        toast.error(errorData.message || t('auth.messages.signUpFailed'))
        setIsLoading(false)
        return
      }
      ...
      toast.error(t('auth.messages.signUpFailed'))
    } finally {
      setIsLoading(false)
    }
  }
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <PasswordInput placeholder={t('auth.signUp.passwordPlaceholder')} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <PasswordInput placeholder={t('auth.signUp.confirmPasswordPlaceholder')} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
